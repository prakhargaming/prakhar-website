...
export default function Chat_Window({ isDarkMode }: darkMode) {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hi, my name is PrakharGaming, I am an RAG-Enabled LLM based on Google Gemini 2.0 Flash and I'm here to answer questions about Prakhar's software engineering background! How can I help you?",
      sender: "bot",
    },
  ]);
  ...
  return (
    <div className="flex flex-col h-full md:w-3/4 justify-self-center max-sm:w-full max-sm:pt-5">
            ...
            <ReactMarkdown
              ...
              components={{
                ...
                ol: ({ node, ...props }) => (
                  <ol
                    {...props}
                    className="list-decimal list-inside last:mb-2"
                  />
                ),
                li: ({ node, ...props }) => (
      ...
      <div className="w-full md:hidden">
        <div
          className={`grid grid-cols-10 p-4
